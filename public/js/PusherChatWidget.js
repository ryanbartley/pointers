...
function PusherChatWidget(pusher, options) {
    ...
    this._nickname = this.settings.user.firstname+" "+this.settings.user.lastname;
    this._email = this.settings.user.email;  
...
PusherChatWidget.prototype._sendChatButtonClicked = function() {
    ...
    var chatInfo = {
        ...
        propic: this.settings.user.propic,
...
PusherChatWidget._createHTML = function(appendTo) {
    var html = '' +
    '<div class="pusher-chat-widget"><p>' +
