...
function PusherChatWidget(pusher, options) {
  ...
  this._nicknameEl = $("#chatpageuser").attr("name");
  this._emailEl = $("#chatpageuser").attr("email");  
...
PusherChatWidget.prototype._sendChatButtonClicked = function() {
  var nickname = $("#chatpageuser").attr("name"); // optional
  var email = $("#chatpageuser").attr("email"); // optional
  if(!nickname) {
...
PusherChatWidget._buildListItem = function(activity) {
  ...
  var image = $('<div class="image">' +
                  '<img src="'+ $("#chatpageuser").attr("picture") +'" width="' + imageInfo.width + '" height="' + imageInfo.height + '" />' +
                '</div>');
  item.append(image);
  ...
  var user = $('<div class="activity-row">' +
                '<span class="user-name">' +
                  '<a class="screen-name" href="' + $("#chatpageuser").attr("profile") + '" title="' + $("#chatpageuser").attr("profile") + '">' + $("#chatpageuser").attr("profile") + '</a>' +
